const projects = [
	...
	},
	{
		...
		description:
			'Lorem ipsum dolor sit amet consectetur adipisicing elit. Labore laborum iure animi, molestiae at ab. Et quas, eaque, fuga pariatur neque labore dolore, quisquam ab soluta asperiores facilis non reprehenderit nisi ratione dolore. Corporis autem repellendus eaque',
		liveButton: 'https://sergioperalta22.github.io/Portfolio/',
		sourseButton: 'https://github.com/SergioPeralta22/Portfolio',
	},
	{
		...
		badges: ['html', 'Ruby on Rails', 'css', 'javaScript'],
		description:
			'Lorem ipsum dolor sit amet consectetur, adipisicing elit. Fugiat voluptatum tempore aliquid nisi. Repellendus neque alias odit? Ipsa minus eligendi in perferendis? Ratione commodi, deserunt dicta architecto vitae animi ab quibusdam blanditiis!  . Eos suscipit quaerat.',
		liveButton: 'https://sergioperalta22.github.io/Portfolio/',
		sourseButton: 'https://github.com/SergioPeralta22/Portfolio',
	},
	{
		...
		badges: ['html', 'Ruby on Rails', 'css', 'javaScript'],
		description:
			'Lorem, ipsum dolor sit amet consectetur adipisicing elit. Exercitationem ea in, tenetur officia quam nobis et natus dolor adipisci nulla laudantium magni, laboriosam ducimus, quo vitae  alias nemo officia tenetur inventore minus, aspernatur dolorem t error',
		liveButton: 'https://sergioperalta22.github.io/Portfolio/',
		sourseButton: 'https://github.com/SergioPeralta22/Portfolio',
	},
];
...
`;
	...
	modalBadges.innerHTML = project.badges
		.map((badge) => `<span class="badge">${bage}</span>`)
		.join('');
